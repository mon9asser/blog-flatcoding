...
export default function Tab ({upcoming, adsReady}) {
                    ...
                    <div className="row mlr--15">
                        <div className="md-9 text-center offset-left offset-right p-all-15 flexbox content-center column-direction tutorial-header-block"> 
                            ...
                            <div className="mt-20 content-elem">
                                <GenerateTutorialContent_tab adsReady={adsReady} ad_camp={upcoming.ads} built_url={`${upcoming.site_url}tutorials/${upcoming.tutorial.slug}/t/${upcoming.tab.slug}/`} upcoming={upcoming} data={upcoming.tab.description} />
                            </div> 
