...
export default function Search({ upcoming, adsReady }) {
    ...
    var SearchFormComponent = () => {
        return (
            <div className="error-message-container">
                ...
                <SearchComponent/>
                 {adsReady?<AdCompaignBox settings={upcoming.settings} data={upcoming.ads} position={'before_search_results'} />: ''}
                <p>
                 ...
                 {adsReady?<AdCompaignBox settings={upcoming.settings} data={upcoming.ads} position={'inside_content'} />: ''}
                <p>
                Whether you're searching for articles, tutorials, or products, our search tool makes it easy to discover the information you need.
                 ...
                 {adsReady?<AdCompaignBox settings={upcoming.settings} data={upcoming.ads} position={'after_search_results'} />: ''}
            </div>          
        )
    }
