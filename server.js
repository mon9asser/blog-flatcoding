...
const corsOptions = {
    origin: [  'https://api.flatcoding.com', 'https://admin.flatcoding.com', 'https://media.flatcoding.com', 'https://flatcoding.com', 'http://localhost:3001', 'http://localhost:3002' ], // Allow only this origin
